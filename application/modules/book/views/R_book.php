...
<body id="pageContent">
	...
	<div class="page-wrap">
		<nav class="navbar navbar-expand-lg fixed-top mb-20 bgboo" style="height: 60px;">
			<div class="container">
					...
					<div class="row form_book">
						...
						<div class="media mb-20">
							...
							<div class="media-body mt-5">
								<div><h5 class="nametitle2 mr-40" style="display: -webkit-inline-box;"><a href="<?php echo site_url('profile/'.$detail_book['data']['author']['author_id'].'-'.url_title($detail_book['data']['author']['author_name'], 'dash', true)); ?>" class="author_name"><?php echo $detail_book['data']['author']['author_name']; ?></a></h5>
									<?php $dat = $this->session->userdata('userData'); if ($detail_book['data']['author']['author_id'] == $dat['user_id']){ ?> <div></div> <?php }else{ ?> <a data-follow="<?php echo $detail_book['data']['author']['author_id']; ?>" class="btn-topup <?php if ($detail_book['data']['author']['isFollow'] == false) { echo "follow-u"; }else{ echo "unfollow-u"; } ?>"><span class="nametitle2 txtfollow" style="font-size: 10px;padding: 0px 15px;"><?php if ($detail_book['data']['author']['isFollow'] == false) { echo "Follow"; }else{ echo "Unfollow"; } ?></span></a></div> <?php } ?>
							</div>
