		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="media">
					...
					<div class="media-body mt-5">
						<div>
							<span><input class="frmcomment commentform" id="comments" placeholder="Tulis sesuatu.." style="width: 70%;height: 45px;" type="text"> <button class="btn Rpost-comment"><span>Kirim</span></button></span>
						</div>
					</div>
				</div><br>
				<br>
