	...
	<div class="page-wrap">
		<nav class="navbar navbar-expand-lg fixed-top baboonav" style="height:55px;background: #fcfcff;">
			<div class="container">
				...
				<button class="btn-transparant" id="publish_chapter"><img src="<?php echo base_url() ?>public/img/assets/icon_publish.png" width="30"> <span style="color: #7554bd;">Publish</span></button>
			</div>
		</nav>
	</div>
	<br>
