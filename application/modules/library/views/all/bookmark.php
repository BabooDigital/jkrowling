...
<body id="pageContent">
	<div class="wrapper" style="background: #f5f8fa;">
		...
		<nav class="navbar navbar-light">
			<a class="menu-page boo-menu" href="<?php echo site_url('library'); ?>" id="tab_page" dat-title="Library"><i class="fa fa-arrow-left fa-2x"></i></a> <h5 style="margin: auto;">Semua Buku Bookmark</h5>
		</nav>
			...
			<div class="row">
				<?php if (!empty($book)) {
					...
					<div class="col-6 mb-30">
						<a href="<?php echo site_url('penulis/'.$b['author_id'].'-'.url_title($b['author_name'], 'dash', true).'/'.$b['book_id'].'-'.url_title($b['title_book'], 'dash', true)); ?>"><img class="rounded" src="<?php echo $b['cover_url']; ?>" width="150" height="180" style="object-fit: cover;"> <img class="markbook" height="40" src="<?php echo base_url('public/img/assets/bookmark.png'); ?>" style="object-fit:cover;" width="30"></a>
						...
						<?php } }else{
							echo "<div class='col-12'><h5 class='text-muted'>Anda belum bookmark buku apapun. Ayo baca lebih banyak buku...</h5></div>";
						} ?>
					</div>
				</div>
