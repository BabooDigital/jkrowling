...
<body id="pageContent">
	<div class="wrapper" style="background: #f5f8fa;">
		...
		<nav class="navbar navbar-light">
			<a class="menu-page boo-menu" href="<?php echo site_url('library'); ?>" id="tab_page" dat-title="Library"><i class="fa fa-arrow-left fa-2x"></i></a> <h5 style="margin: auto;">Semua Buku yang Terakhir di Baca</h5>
		</nav>
			...
			<div class="row">
				<?php if (!empty($book)) {
					...
					<div class="col-6 mb-30">
						...
						<?php } }else{
							echo "<div class='col-12'><h5 class='text-muted'>Anda belum membaca buku satupun. Ayo baca lebih banyak buku...</h5></div>";
						} ?>
					</div>
				</div>
