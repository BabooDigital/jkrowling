	...
	<div class="">
		<ul class="list-unstyled">
			...
			<li class="media bg-white p-15" style="align-items: center;">
				...
				<div class="media-body">
					<p><b>Robert Angelius</b> <span class="text-muted">mulai mengikuti tulisan anda</span></p>
					<p class="text-muted" style="font-size: 11px;">1 hours ago</p>
				</div></a>
			...
			<li class="media bg-white p-15" style="align-items: center;">
				...
				<div class="container">
					<div class="row mb-10">
						...
						<div class="media-body">
							<p><b>Robert Angelius</b> <span class="text-muted">Mengomentari tulisan anda</span></p>
						</div>
					</div>
					<div class="row">
			...
			<li class="media bg-white p-15" style="align-items: center;">
				...
				<div class="container">
					<div class="row mb-10">
						...
						<div class="media-body">
							<p><b>Robert Angelius</b> <span class="text-muted">Menyukai tulisan anda</span></p>
						</div>
					</div>
					<div class="row">
						<img src="http://placehold.it/1000x200" style="width: 100%;height: 150px;">
