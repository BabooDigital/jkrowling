...
<body>
	...
	<p>Go to <strong><a href="<?php echo site_url('notification/C_notification/trigger_event'); ?>" target="_blank">/example/trigger_event</a></strong> in a new tab to trigger event.</p>
