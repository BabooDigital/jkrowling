...
<body class="bg-borr">
	<div class="wrapper">
		...
		<div class="modal fade" id="select_category" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					...
					<div class="modal-body">
						<div class="container mt-20">
							...
							<div class="row">
								...
								<div class="row mt-10">
									<div class="col-12">
										<p style="font-size: 12pt;">*Kamu boleh pilih lebih dari satu sesuai yang kamu suka</p>
