				...
				<div class='card-body p-0 pl-30 pr-30 pt-15'>
					<div class='row mb-10 pl-15 pr-15'>
						<div class='media'>
							...
							<div class='media'>
								<a href='<?php echo site_url(); ?>book/<?php echo $book['book_id']; ?>-<?php echo url_title($book['title_book'], 'dash', true); ?>'><img alt='<?php echo $book['title_book']; ?>' class='w-100 imgcover cover_image' src='<?php echo $book['cover_url']; ?>'></a>
							</div><a class='segment' data-href='<?php echo $book['book_id']; ?>' href='<?php echo site_url(); ?>book/<?php echo $book['book_id']; ?>-<?php echo url_title($book['title_book'], 'dash', true); ?>'>
