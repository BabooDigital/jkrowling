									...
									<div class="media">
										...
										<div class="media-body">
											<div>
												...
												<p style="font-size: 10pt;">by <a href="#"><?php echo $pop['author_name']; ?></a></p>
											</div>
										</div>
									</div>
								</li>
					...
					<div class="col-md-6 all komik" style="margin-right: -15px;">
						<div class="card mb-15" style="padding: 0 10px;">
							<div class="card-body p-0 p-20">
								<div class="row mb-30">
									<div class="media">
										<img alt="Generic placeholder image" class="d-flex align-self-start mr-20 rounded-circle" src="<?php echo base_url(); ?>public/img/profile/pp_wanita2.png" width="60">
										<div class="media-body mt-5">
											<h5 class="card-title nametitle2">Marina Saraswati</h5>
											<p><small><span>Jakarta, Indonesia</span> <span class="ml-10">1 hours ago</span></small></p>
										</div>
								...
								<div class="row">
									<div class="media">
										<img alt="Profile" class="d-flex align-self-start mr-10" src="<?php echo base_url(); ?>public/img/book-cover/book_cover2.png" width="130">
										<div class="media-body">
											<h5 class="card-title nametitle3"><a href="<?php echo site_url(); ?>login">Doraemon</a></h5>
											<p class="catbook mb-10"><a class="mr-20" href="#"><span class="btn-no-fill">KOMIK</span></a> <span class="mr-20"><img src="<?php echo base_url(); ?>public/img/assets/icon_view.svg"> 290</span> <span><img src="<?php echo base_url(); ?>public/img/assets/icon_share.svg"> 12</span></p>
											<p class="text-desc-out">Aku tahu ribuan kalimat kau tulis untuk memberi tanda bahwa kamu selalu sabar menungguku, yang seolah-olah kau ingin mengatakan pada dunia bahwa kamu sangat... <a class="readmore" href="#">Lanjut</a></p>
										</div>
									</div>
								</div>
					...
					<div class="col-md-6 all nonfiksi" style="margin-right: -15px;">
						<div class="card mb-15" style="padding: 0 10px;">
							<div class="card-body p-0 p-20">
								...
								<div class="row">
									<div class="media">
										<img alt="Profile" class="d-flex align-self-start mr-10" src="<?php echo base_url(); ?>public/img/book-cover/book_cover3.png" width="130">
										<div class="media-body">
											<h5 class="card-title nametitle3"><a href="<?php echo site_url(); ?>login">The Painter's Daughter</a></h5>
											<p class="catbook mb-10"><a class="mr-20" href="#"><span class="btn-no-fill">NON-FIKSI</span></a> <span class="mr-20"><img src="<?php echo base_url(); ?>public/img/assets/icon_view.svg"> 290</span> <span><img src="<?php echo base_url(); ?>public/img/assets/icon_share.svg"> 12</span></p>
											<p class="text-desc-out">Aku tahu ribuan kalimat kau tulis untuk memberi tanda bahwa kamu selalu sabar menungguku, yang seolah-olah kau ingin mengatakan pada dunia bahwa kamu sangat... <a class="readmore" href="#">Lanjut</a></p>
										</div>
									</div>
								</div>
