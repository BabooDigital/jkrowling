							...
							<div class="media">
								...
								<div class="row" style="padding: 0px 10px 0px 10px;">
									<div class="media">
										<img alt="<?php
										echo $s_book['title_book']; ?>" src="<?php
										echo $s_book['image_url']; ?>" style="position: relative; width: 100%;height: 200px; -webkit-filter: blur(10px);">
										<img alt="<?php
										echo $s_book['title_book']; ?>" src="<?php
										echo $s_book['image_url']; ?>" style="position: absolute;height: 150px;">
									</div>
