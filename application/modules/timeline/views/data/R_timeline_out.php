	...
	<?php if ($s_book['image_url'] == "" || $s_book['image_url'] == null): ?>
		<div class="card mb-15" style="padding: 0 00px;">
			<div class="card-body p-0 p-20">
				<div class="row mb-20" style="padding: 0px 10px 0px 10px;">
					<div class="media">
							...
							<div class="row">
								<div class="media w-100">
									<div class="media-body p-10">
										<img alt="<?php
										echo $s_book['title_book']; ?>" class="d-flex align-self-start mr-10 float-left" src="<?php if ($s_book['cover_url'] != NULL){ echo $s_book['cover_url']; }else{ echo base_url('public/img/profile/blank-photo.jpg'); } ?>" width="120" height="170">
