			...
			<div style="padding:5%;">
				<div class="media">
					...
					<div class="media-body pinkslide">
						...
						<p style="font-size:12px;"><?php echo substr($slide_show['popular_book_desc'], 0, 80).'...'; ?></p>
						<div class="mt-10"><a href="<?php echo site_url(); ?>book/<?php echo $slide_show['popular_book_id']; ?>" class="btnbooreadmr"><span style="">Baca Buku</span></a></div>	
					</div>
				</div>								
			</div>
	</div>
