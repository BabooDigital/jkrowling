<?php foreach ($slide['data'] as $key => $slide_show):
	...
	<div class="<?php echo ($key%2==0) ? 'rpinkslidebg' : 'rblueslidebg'; ?>">
			<div style="padding:5%;">
				<div class="media">
					<img class="d-flex mr-3" src="<?php echo ($slide_show['popular_cover_url'] != null) ? $slide_show['popular_cover_url'] : base_url('public/img/blank_cover.png'); ?>" alt="<?php
					...
					<div class="media-body pinkslide">
						...
						<div><a href="<?php echo $this->baboo_lib->urlToBook($urlToUser, $urlToBook); ?>" class="btnbooreadmr"><span style="">Baca Buku</span></a></div>
					</div>
				</div>
			</div>
	</div>
