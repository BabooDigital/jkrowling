            ...
            .done(function(data) {
                ...
                if (search.length >=3) {
                    ...
                    $.each(data['user'], function(index, val) {
                        list_user += '<a class="dropdown-item profile"  data-usr-prf="'+val.user_id+'" data-usr-name="'+convertToSlug(val.fullname)+'" href="'+base_url+'penulis/'+convertToSlug(val.fullname)+'">'+val.fullname+'</a>';
                    });
