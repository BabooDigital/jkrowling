                    ...
                    if (data.length !== 0){
                        ...
                        $.each(data, function(index, val) {
                            ...
                            if (val.notif_type.notif_type_id == 1) {
                                ...
                                datas += '<a href="'+base_url+'book/'+val.notif_book.book_id+'-'+convertToSlug(val.notif_book.title_book)+'" class="list-group-item list-group-item-action flex-column align-items-start btn_notif_publish" '+add_style+' id="" ntf="'+val.notif_id+'" id="btn_notif_upd"> <div class="row mb-10" style="padding: 0px 10px 0px 10px;text-align: left;"> <div class="media" style="width: 100%;"> <div class="media-body"> <span class="nametitle2"></span> <br> <p class="" style="margin-bottom:-5px !important;">'+val.notif_text+'</p> <span class="text-muted" style="font-size:  8pt;">'+val.notif_time+'</span></div> </div> </div> </a>';
