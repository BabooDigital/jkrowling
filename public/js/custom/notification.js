                    ...
                    if (data.length !== 0){
                        ...
                        $.each(data, function(index, val) {
                            ...
                            if (val.notif_type.notif_type_id == 1) {
                                ...
                                datas += "<a href='"+base_url+'penulis/'+convertToSlug($('#name_sess').val())+'-'+$('#uid_sess').val()+'/'+convertToSlug(val.notif_book.title_book)+'-'+val.notif_book.book_id+"' class='list-group-item list-group-item-action align-items-start' "+add_style+" id='btn_notif_upd' ntf='"+val.notif_id+"'> <div class='row'><div><img alt='Follow you' class='mr-5' height='25' src='"+base_url+"public/img/assets/notif_comment.png' width='25'> <img alt='"+val.notif_user.fullname+"' class='mr-10 rounded-circle' height='35' src='"+user+"' width='35' style='object-fit:  cover; '></div> <div class='media-body' style='text-align:  left !important;'><p style='margin-bottom: -5px !important;line-height: 15px;'><span style='font-size: 11pt; '><b>"+val.notif_user.fullname+"</b> "+val.notif_text+"</span></p><span style='font-size:  8pt; 'class='text-muted'>"+val.notif_time+"</span></div><div class='mt-5'><img src='"+val.notif_book.cover_url+"' style='width: 100%;height:100px;object-fit:cover;'></div></div> </a>";
                                ...
                                datas += '<a href="'+base_url+'penulis/'+convertToSlug($('#name_sess').val())+'-'+$('#uid_sess').val()+'/'+convertToSlug(val.notif_book.title_book)+'-'+val.notif_book.book_id+'" class="list-group-item list-group-item-action flex-column align-items-start btn_notif_publish" '+add_style+' id="" ntf="'+val.notif_id+'" id="btn_notif_upd"> <div class="row mb-10" style="padding: 0px 10px 0px 10px;text-align: left;"> <div class="media" style="width: 100%;"> <div class="media-body"> <span class="nametitle2"></span> <br> <p class="" style="margin-bottom:-5px !important;">'+val.notif_text+'</p> <span class="text-muted" style="font-size:  8pt;">'+val.notif_time+'</span></div> </div> </div> </a>';
