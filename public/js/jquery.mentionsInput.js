...
(function ($, _, undefined) {
    ...
    var defaultSettings = {
        ...
        templates     : {
            ...
            autocompleteListItem       : _.template('<li data-ref-id="<%= user_id %>" data-ref-type="<%= type %>" data-display="<%= display %>"><%= content %></li>'),
        ...
        function populateDropdown(query, results) {
            ...
            _.each(results, function (item, index) {
                ...
                var elmListItem = $(settings.templates.autocompleteListItem({
                    'user_id'      : utils.htmlEncode(item.user_id),
                ...
                if (settings.showAvatars) {
                    ...
                    if (item.prof_pict) {
                        elmIcon = $(settings.templates.autocompleteListItemAvatar({ prof_pict : item.prof_pict }));
