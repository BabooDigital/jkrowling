...
App.prototype.doOpenBook = function () {
    ...
    fi.setAttribute('id', 'file-to-upload');
...
App.prototype.doReset = function () {
    ...
    this.qs(".book").innerHTML = '<div class="empty-wrapper"><div class="empty"><div class="app-name">ePUB Uploader</div><div class="message"><a href="javascript:ePubViewer.doOpenBook();" class="big-button">Pilih File ePUB</a></div></div></div>';
